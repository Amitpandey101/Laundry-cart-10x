										...
										<th scope="row" className="product-row">
											...
											<span to="/" className="nav-link cust-link-product">
												<span className="user-acc">
													<img className="product-img" src="./acc.png" alt="" />
												</span>
												<div className="product-name">
													<span>Shirts</span>
													<span className="description">
														Lorem ipsum dolor sit amet consectetur, adipisicing
														elit. Voluptate, dolorem?
													</span>
												</div>
											</span>
										</th>
											...
											<span className="nav-link cust-link-product">
												...
												<div className="product-name">
													...
													<div className="description">
														Lorem ipsum dolor sit amet, consectetur adipisicing
														elit. Sunt beatae accusantium nihil!
													</div>
												</div>
											</span>
										</th>
														...
														{orderData.map((item, key) => {
															return item.quantity > 0 ? (
																<div>
																	...
																	{item.total} {item.cost} {item.washtype.key}
																	{item.washtype.key}
																	{item.washtype.key}
																	{item.washtype.key}
																</div>
